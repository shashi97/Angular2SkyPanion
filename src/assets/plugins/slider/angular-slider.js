    ...
    sliderDirective = function ($timeout) {
        return {
            ...
            compile: function (element, attributes) {
                ...
                if (attributes.customFloor) bindHtml(flrBub, "translate({value: customFloor})");
                if (attributes.customCeiling) bindHtml(ceilBub, "translate({value: customCeiling})");
                ...
                return {
                    post: function (scope, element, attributes) {
                        ...
                        dimensions = function () {
                            ...
                            minValue = (!attributes.customFloor) ? parseFloat(attributes.floor) : parseFloat(scope["customFloor"]);
                            maxValue = (!attributes.customCeiling) ? parseFloat(attributes.ceiling) : parseFloat(scope["customCeiling"]);
