...
@Component({
	selector: 'sp-invoice-entry-distributions',
	templateUrl: 'invoice-entry-distributions.component.html'
})

export class InvoiceEntryDistributionsComponent extends BaseComponent implements OnInit {
